...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "Polcoin-seeder\n"
...
static const string mainnet_seeds[] = {"polcoin.one.pl", "salomon.styx.net.pl", "rav3n.dtdns.net", "burzuj.net", ""};
static const string testnet_seeds[] = {"", ""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("kjy2eqzk4zwi5zd3.onion", 9338), true);
  }
  do {
